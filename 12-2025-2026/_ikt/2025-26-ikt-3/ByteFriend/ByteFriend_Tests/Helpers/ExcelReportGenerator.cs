...
{
    private static readonly ConcurrentBag<TestResultModel> TestResults = new();
    private static readonly ConcurrentDictionary<string, DateTime> TestStartTimes = new();
    ...
    public static void EndTest()
    {
        ...
        var testStartTime = TestStartTimes.TryGetValue(testId, out var startTime) ? startTime : testEndTime;
        ...
        TestStartTimes.TryRemove(testId, out _);
    }
