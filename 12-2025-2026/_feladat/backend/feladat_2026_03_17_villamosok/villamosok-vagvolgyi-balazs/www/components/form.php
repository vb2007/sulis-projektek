...
<form action="index.php" method="GET" class="mb-4 p-4 bg-gray-50 rounded-lg border border-gray-300">
    <div class="flex flex-wrap gap-4 items-end">
        <div class="flex flex-col">
            ...
            <input type="text" name="terminus" id="terminus" class="border border-gray-300 rounded px-2 py-1" value="<?= htmlspecialchars(
                $_GET["terminus"] ?? "",
            ) ?>">
        </div>
    ...
    : "" ?>><?= htmlspecialchars($value) ?></option>
        ...
        <div class="flex flex-col">
            ...
            <input type="number" name="since" id="since" class="border border-gray-300 rounded px-2 py-1" value="<?= htmlspecialchars(
                $_GET["since"] ?? "",
            ) ?>">
        </div>
